      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-24 md:space-y-32 py-16">
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="card p-8 text-center bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-xl transition-transform hover:-translate-y-2">
                ...
                <p className="text-slate-400">Login and let our system calculate your Developer Reputation Score (DRS) based on your public contributions.</p>
              </div>
              <div className="card p-8 text-center bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-xl transition-transform hover:-translate-y-2">
                ...
                <p className="text-slate-400">Use your high score to back developers you trust by staking collateral and minting a Vouch SBT on-chain.</p>
              </div>
              <div className="card p-8 text-center bg-slate-900/60 backdrop-blur-sm border border-slate-800 rounded-xl transition-transform hover:-translate-y-2">
                ...
                <p className="text-slate-400">Help talented builders access opportunities and strengthen the ecosystem while building your on-chain credibility.</p>
              </div>
            </div>
          </section>
          ...
          <section className="text-center">
            <h2 className="text-3xl font-bold text-white mb-4">A Simple, Powerful Flow</h2>
            <p className="text-lg text-slate-300 mb-12 max-w-2xl mx-auto">Follow these steps to become an active participant in the RepuFi network.</p>
